...
def sample(accelerator, vae, text_encoder, flux, output_dir, sample_images, sample_prompts):
        ...
        for image_path, prompt_dict in zip(sample_images, sample_prompts):
            ...
            if prompt not in conditions:
                ...
                img_transforms = transforms.Compose([
                    ResizeWithPadding(size=352, fill=0),
                    transforms.ToTensor(),
...
def main(args):
    ...
    sample(accelerator, vae=ae, text_encoder=text_encoder, flux=model, output_dir=OUTPUT_DIR,
